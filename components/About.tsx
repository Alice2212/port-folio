  ...
  return (
    ...
    >
      <div className="container mx-auto ">
        <h2 className="text-4xl font-bold mb-5 border-b-[5px] w-[180px] border-violet-600 pb-2 text-center lg:text-left order-2 lg:order-1">
          About Me
        </h2>
        <div className="about-info flex flex-wrap items-center justify-center md:justify-between">
          ...
          <div className="about-img lg:pt-0 pt-8  order-1 lg:order-2">
            <Image
